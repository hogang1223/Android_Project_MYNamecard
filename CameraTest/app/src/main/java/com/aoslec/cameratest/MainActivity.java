...
public class MainActivity extends AppCompatActivity {
    ...
    private String serverURL = "http://192.168.219.105:8080/first/imageTest.jsp";  //<<서버주소
        ...
        if (requestCode == REQ_CODE_SELECT_IMAGE) {
            if (resultCode == Activity.RESULT_OK) {
                try {
                    ...
                    ImageView image = findViewById(R.id.imageview);  //이미지를 띄울 위젯 ID값
