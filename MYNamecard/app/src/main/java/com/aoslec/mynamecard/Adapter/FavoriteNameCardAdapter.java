...
public class FavoriteNameCardAdapter extends RecyclerView.Adapter<FavoriteNameCardAdapter.ViewHolder> implements ItemTouchHelperListener {

    private Context context = null;
    private ArrayList<NameCard> data = null;
    private String macIP = null;

public FavoriteNameCardAdapter(Context context, ArrayList<NameCard> data, String macIP){
...
public class ViewHolder extends RecyclerView.ViewHolder{
    ...
    @NonNull
    @Override
    public FavoriteNameCardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.namecard_layout, parent, false);
        FavoriteNameCardAdapter.ViewHolder viewHolder = new FavoriteNameCardAdapter.ViewHolder(v);
        Log.v("SelectNamecard", "viewHolder");
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteNameCardAdapter.ViewHolder holder, int position) {
    ...
    private String connectTrashCanData(int namecardNo){
        String result = null;
        String urlAddr = "http://" + macIP + ":8080/first/namecardFavoriteDelete.jsp?namecardNo=" + namecardNo;
        try {
